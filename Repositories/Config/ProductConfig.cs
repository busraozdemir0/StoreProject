...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.HasData(  // veritabanı sıfırlansa bile bu veriler otomatik eklenecektir.
                ...
                new Product() { ProductId = 8,CategoryId=2,ImageUrl="/images/8.jpg", ProductName = "Xp-Pen", Price = 1145 ,ShowCase=true},
                new Product() { ProductId = 9,CategoryId=1,ImageUrl="/images/9.jpg", ProductName = "Galaxy FE", Price = 4460,ShowCase=true},
                new Product() { ProductId = 10,CategoryId=2,ImageUrl="/images/10.jpg", ProductName = "Hp Mouse", Price = 545,ShowCase=true }
            );
        }
    }
}